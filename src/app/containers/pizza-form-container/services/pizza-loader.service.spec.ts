...
describe('PizzaLoaderService', () => {
  ...
  it('should change selected state of selected items', inject(
    [PizzaLoaderService],
    (service: PizzaLoaderService) => {
      const TOPPINGS_DATA = [
        {
          selected: false,
      ...
      const result = service.prefillToppingsSelection(TOPPINGS_DATA, [
        PizzaToppingsEnum.MUSHROOMS,
